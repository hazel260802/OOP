...
public class getDiaDiemLichSu {
	...
	public static void GetThongTinDiaDiemThuVienLS(WebDriver driver,String href, List<DiaDiemLichSu> listDiaDiem) throws ParseException {
		
		List<String> listNhanVatLienQuanTamThoi = new ArrayList<String>();
	    List<String> listSuKienLienQuanTamThoi = new ArrayList<String>();
	    ...
	    // Sự kiện liên quan
	    try {
		    WebElement suKienLienQuan = driver.findElement(By.xpath("//h3[contains(text(),'Sự kiện liên quan')]"));
		    
		    List<WebElement> tenSuKienLienQuan = driver.findElements(By.xpath("/html[1]/body[1]/div[1]/div[3]/div[2]/div[1]/div[5]/div/div[1]/div[2]/div[1]/h4[1]"));  	
		    
		    tenSuKienLienQuan.forEach(e -> {
		    	String Ten2 = e.getText().trim();
		    	String[] Ten1 = Ten2.split("\\(");
		    	listSuKienLienQuanTamThoi.add(Ten1[0].trim());
		    });
	    } catch (Exception e) {
	    ...
	    // Nhân vật liên quan
	    try {
		    WebElement nhanVatLienQuan = driver.findElement(By.xpath("//h3[contains(text(),'Nhân vật liên quan')]"));
		    
		    List<WebElement> tenNhanVatLienQuan = driver.findElements(By.xpath("/html[1]/body[1]/div[1]/div[3]/div[2]/div[1]/div[5]/div/div[1]/div[2]/div[1]/h4[1]"));  	
		...
		DiaDiemLichSu NhanVatTamThoi= new DiaDiemLichSu(); // TODO : làm lại models Địa điểm
		
		// thêm nhân vật vô list
		listDiaDiem.add(NhanVatTamThoi); // TODO : adđ theo địa điểm trên <not complete>
	}
	...
	public static void main(String[] args) throws InterruptedException, ParseException {
			...
			List<DiaDiemLichSu> listDiaDiem = new ArrayList<DiaDiemLichSu>();
